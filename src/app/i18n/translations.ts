...
export const translations = {
  es: {
    ...
    hero: {
      intro: 'Hola, soy',
      role: 'Estudiante de Ingeniería de Software | Desarrollador Full Stack',
      quote: 'Dedicado a dominar el ecosistema digital a través del aprendizaje práctico.',
    ...
    sections: {
      ...
      projectsSubtitle: 'Una selección de proyectos que demuestran mis habilidades en desarrollo Full Stack',
      experienceTitle: 'Experiencia &',
      experienceAccent: 'Tecnologías',
      testimonialsTitle: 'Testimonios &',
      testimonialsAccent: 'Recomendaciones',
      testimonialsSubtitle: 'Lo que dicen quienes han trabajado conmigo',
      contactTitle: 'Contácta',
      contactAccent: 'me',
      contactSubtitle: '¿Tienes un proyecto en mente? Conversemos sobre cómo puedo ayudarte.',
    },
    about: {
      card1Title: 'Colaboración efectiva',
      card1Text:
        'Orientado a la colaboración efectiva y al fortalecimiento de la dinámica de equipo, con enfoque en la comunicación clara y el trabajo conjunto para alcanzar objetivos comunes.',
      card2Title: 'Crecimiento profesional',
      card2Text:
        'Motivado por integrar equipos de desarrollo para aplicar mis conocimientos y crecer profesionalmente en entornos desafiantes que impulsen mi desarrollo técnico y personal.',
      card3Title: 'Aprendizaje continuo',
      card3Text:
        'Comprometido con el aprendizaje continuo y la excelencia en el desarrollo de software, manteniéndome actualizado con las últimas tecnologías y mejores prácticas del sector.',
      summaryTitle: 'Mi enfoque',
      summaryP1:
        'Como estudiante de Ingeniería de Software y desarrollador Full Stack, me apasiona crear soluciones digitales innovadoras que combinen funcionalidad, diseño y experiencia de usuario.',
      summaryP2:
        'Mi formación académica, combinada con proyectos prácticos, me ha permitido desarrollar habilidades técnicas sólidas en desarrollo web moderno, desde el frontend hasta el backend, utilizando tecnologías como React, JavaScript, Python y bases de datos.',
      summaryP3:
        'Creo firmemente en la importancia del código limpio, las mejores prácticas de desarrollo y el trabajo en equipo. Mi objetivo es contribuir a proyectos significativos donde pueda aplicar mis conocimientos, aprender de profesionales experimentados y seguir evolucionando como desarrollador.',
      summaryP4:
        'La disciplina, la curiosidad técnica y el compromiso con la excelencia son los pilares que guían mi desarrollo profesional en el ecosistema tecnológico.',
    },
    projects: {
      oneGameDescription:
        'Es una réplica completa y fiel del clásico juego de cartas UNO, desarrollada con Next.js 15, TypeScript y Tailwind CSS. Incluye soporte para 2-4 jugadores (con IA para bots), todas las cartas especiales (+2, +4, Saltar, Invertir y Comodín), animaciones 3D suaves y un diseño visual espectacular con efecto glassmorphism y fondo galáctico.',
      featured: 'Destacado',
    ...
    experience: {
      ...
      stackIntro: 'Dominio de tecnologías modernas para el desarrollo de aplicaciones web completas y escalables.',
    ...
    testimonials: {
      role1: 'Compañero de equipo - Universidad',
      text1:
      ...
      text2:
        'Sebastian se encargó de manera excepcional de la administración de nuestra base de datos y del desarrollo de la página principal de nuestra veterinaria Clinican. Su trabajo en el sistema de gestión de mascotas para el servicio de peluquería fue impecable, demostrando profesionalismo, responsabilidad y gran capacidad técnica. Es un desarrollador confiable y comprometido con la excelencia.',
