                ...
                <Card hover={false} className="h-full">
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-4 pt-4 border-t border-gray-800">
                      <div className={`w-14 h-14 rounded-full flex items-center justify-center bg-gradient-to-br from-[#111827] to-[#0F172A] border-2 ${testimonial.color === 'text-[#22C55E]' ? 'border-[#22C55E]/30' : 'border-[#3B82F6]/30'}`}>
                        <IconComponent className={testimonial.color} size={28} />
                      </div>
                      <div>
